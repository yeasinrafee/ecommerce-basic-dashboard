...
export const useCreateCategory = () => {
  ...
  return useMutation({
    mutationFn: async (name: string) => {
      const response = await apiClient.post<ApiResponse<Category>>(ProductCategoryRoutes.create, { name });
...
export const useUpdateCategory = () => {
  ...
  return useMutation({
    mutationFn: async ({ id, name }: { id: string; name: string }) => {
      const response = await apiClient.patch<ApiResponse<Category>>(ProductCategoryRoutes.update(id), { name });
